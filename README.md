...
clean, and publish standardized compliance reports.
* Reduced report preparation from approximately two hours to under five minutes, minimizing manualformatting andtranscription
errors.
...
**Languages:** Python, C, JavaScript, TypeScript, HTML, CSS, C++  
**Frontend:** React, React Native, Tailwind CSS  
**Backend & Data:** Node.js, Express, Django, PostgreSQL, Drizzle, Supabase, REST  
**Cloud & DevOps:** AWS CDK, EC2, ECS, IAM, S3, RDS, Lambda, CloudFront, Docker & Docker Compose, GitHub Actions  
**Libraries & Tools:** pandas, Axios, Jest, Supertest, Zod, Pytest

## Contact

- Email: [danielngira@uchicago.edu](mailto:danielngira@uchicago.edu)
- GitHub: [@danielngira](https://github.com/danielngira)
- LinkedIn: [danielngira](https://www.linkedin.com/in/danielngira)
